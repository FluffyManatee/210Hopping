                ...
                <div class="row">
                    <table class="table table-condensed col-xs-12">
                        <div class="container">
                            ...
                            <h4>Head Hopper:</h4>
                            <a href="/users/{{ $gameplan->author->id }}"><h5>{{ $gameplan->author->first_name . ' ' . $gameplan->author->formatLastName() }}</h5></a>
                            ...
                            @foreach($gameplan->bars as $index => $gpbar)
                                                <div data-value="{{ $gpbar->bar->id }}" class="item @if($index == 0) {{ 'active' }} @endif">
